...
public class LoginDataBaseAdapter {
    ...
    static final String DATABASE_CREATE = "create table " + "LOGIN" +
            "( " + "ID" + " integer primary key autoincrement," + "USERNAME  text,PASSWORD text, CONTACT text, LOCATION text, EMAIL text); ";
    ...
    public void insertEntry(UserDBObj u) {
        ...
        newValues.put("LOCATION", u.location);
    ...
    public UserDBObj getSinlgeEntry(String email) {
        ...
        UserDBObj u = new UserDBObj(userName, password, contact, location, email);
        cursor.close();
        return u;
    }
    ...
    public void updateEntry(UserDBObj u, boolean resetPass) {
        ...
        updatedValues.put("LOCATION", u.location);
        updatedValues.put("CONTACT", u.emergContact);
        String where = "USERNAME = ?";
        db.update("LOGIN", updatedValues, where, new String[]{u.userName});
    }
}
